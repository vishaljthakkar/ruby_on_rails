...
Person.first.jobs.create! [
                              {title: "Developer", company: "Microsoft", position_id: "#1234"},
                              {title: "Developer", company: "Microsoft", position_id: "#1235"}
                          ]

Person.last.jobs.create! [
                             {title: "Sr. Developer", company: "Google", position_id: "#5234"},
                             {title: "Sr. Developer", company: "Google", position_id: "#5235"}
                         ]
